$(function () {
	...
	//по окончании задержки выполняем функцию doneResizing 
	function doneResizing(){
		if ($(window).width() < 576) {
			var hslide = $("#page-gallery .slick-slide:first-child img").outerHeight();
			$("#page-gallery").css("--heightSlide", hslide + "px");
		}
	}
